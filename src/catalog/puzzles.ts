...
const CANONICAL_PUZZLES = [
  ...
  },
  {
    ...
    rows: ["OOOOO", "O AaO", "O   O", "O R O", "OOOOO"],
  },
  {
    id: "tutorial-corner",
    title: "Corner Lesson",
    ...
    rows: ["OOOOOO", "O    O", "O RA O", "O  a O", "O    O", "OOOOOO"],
  },
  {
    id: "tutorial-around",
    title: "Go Around",
    ...
    rows: ["OOOOOOO", "OR    O", "OOOOA O", "O   a O", "OOOOOOO"],
  },
  {
    id: "beginner-three",
    ...
    rows: ["OOOOOOOO", "O R    O", "O AXXO O", "O aSSO O", "O      O", "OOOOOOOO"],
  },
  {
    id: "beginner-detour",
    title: "The Detour",
    ...
    rows: ["OOOOOOOO", "OR     O", "OOOO A O", "OS   X O", "Oa     O", "OOOOOOOO"],
  },
  {
  ...
  },
  {
    ...
    rows: ["OOOOO", "OaA O", "O XRO", "O  SO", "OOOOO"],
  },
  {
    id: "medium",
    title: "Color Wheel",
  ...
  },
  {
    ...
    rows: ["OOOOOOOOOOO", "O    O    O", "O RA   XS O", "O XO O OX O", "OaSO   OS O", "OOOOOOOOOOO"],
  },
  {
    id: "corridor-2",
    title: "The Pipe",
    ...
    rows: ["OOOOOOOOOOO", "O a O     O", "O   O A   O", "O     R   O", "O   O X   O", "O S O     O", "OOOOO X   O", "OOOOOO  S O", "OOOOOOOOOOO"],
  },
  {
    id: "garden-2",
    title: "Garden Path",
  ...
  },
  {
    ...
    rows: ["OOOOOOO", "O   R O", "O OAO O", "O X   O", "OSX   O", "Oa    O", "OS    O", "OOOOOOO"],
  },
  {
    id: "classic-1",
    ...
    rows: ["OOOOOOO", "O     O", "O OAO O", "O  X  O", "OO X OO", "O  R  O", "O SaS O", "OOOOOOO"],
  },
  {
    id: "theme-kitchen",
    ...
    rows: ["OOOOOOOOO", "O R     O", "O  OOO  O", "O A O X O", "O  O    O", "O  O  X O", "O aSS   O", "OOOOOOOOO"],
  },
  {
    id: "large",
    title: "The Warehouse",
  ...
  },
  {
    ...
    rows: ["OOOOOOOOOO", "O R      O", "O OOOOOO O", "O O    O O", "O A aS X O", "O O    O O", "O OXOOXO O", "O        O", "O   SS   O", "OOOOOOOOOO"],
  },
  {
    id: "box-7x7",
    title: "Lucky Seven",
    ...
    rows: ["OOOOOOO", "Oa   SO", "O  A  O", "O XRXOO", "O  X  O", "OS   SO", "OOOOOOO"],
  },
  {
    id: "sym-diamond",
    title: "Diamond",
    ...
    rows: ["OOOOOOOOOOO", "OOOOO OOOOO", "OOOO   OOOO", "OOO  S  OOO", "OO  ARX  OO", "O    X    O", "OO   S   OO", "OOO  a  OOO", "OOOO   OOOO", "OOOOO OOOOO", "OOOOOOOOOOO"],
  },
  {
    id: "theme-library",
    title: "The Library",
  ...
  },
  {
    ...
    rows: ["OOOOOOOOOOOOOOOOOOOO", "OaA                O", "OS  X              O", "OS                 O", "OS                 O", "OS                 O", "OS                 O", "OS                 O", "OS                 O", "OS                 O", "OX        R        O", "O   X              O", "OX                 O", "O   X              O", "OX                 O", "O   X              O", "OX                 O", "O   X              O", "OS                 O", "OOOOOOOOOOOOOOOOOOOO"],
  },
  {
    id: "huge",
    title: "Grand Hall",
  ...
  },
  {
    ...
    rows: ["OOOOOOOOOOOO", "O R  O     O", "OOO  O OOO O", "O A  O O S O", "O OO   O   O", "O O  OOOO  O", "O   XO  X  O", "OOOO OS    O", "O  X    OO O", "O SaS X    O", "OOOOOOOOOOOO"],
  },
  {
    id: "expert-tetris",
    title: "Block Party",
    ...
    rows: ["OOOOOOOOO", "O   R   O", "O  A X  O", "OOX   XOO", "OO     OO", "OO X X OO", "OOSSSSSOO", "OO  a  OO", "OOOOOOOOO"],
  },
  {
    id: "theme-museum",
