(function exposeSokomindPuzzles(root) {
  ...
  const PUZZLES = {
    ...
    // =====================================================================
    //  INTERMEDIATE TIER (3-5 boxes, real thinking required)
    // =====================================================================
    ...
    // =====================================================================
    //  EXPERT TIER (5-12 boxes, deep thinking)
    // =====================================================================
    ...
    // =====================================================================
    //  MASTER TIER (8+ boxes, serious challenge)
    // =====================================================================
  ...
  function orderedKeys() {
    const entries = Object.keys(PUZZLES);
    const ordered = [];
    for (const tier of DIFFICULTY_ORDER) {
      for (const key of entries) {
        if (PUZZLES[key].difficulty === tier) ordered.push(key);
      }
    }
    const grouped = new Set(ordered);
    for (const key of entries) {
      if (!grouped.has(key)) ordered.push(key);
    }
    return ordered;
  }
