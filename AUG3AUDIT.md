...
| CRITICAL | 2 | A1, A2 |
| HIGH | 3 | B1, C1, D1 |
| MEDIUM | 12 | B2, B3, B4, C2, C3, C4, E1, E4, F1, G1, H1, H2 |
...
**Sprint 1 (19 files modified + 1 new):**
...
- `src/features/experience/ExperienceControls.tsx`
- `src/features/solver/SolverDialog.tsx`
...
- `src/catalog/puzzles.ts`
- `src/catalog/puzzle-metadata.ts`
- `src/catalog/puzzle-loader.ts`
- `src/solver/search/model.ts`
- `src/solver/search/ida-star.ts`
- `src/solver/implementations/sokomind-engine/engine.generated.d.ts`
- `src/features/play/use-persisted-play.ts`
- `src/features/game/Board.module.css`
- `src/features/game/GameControls.module.css`
- `src/features/game/GameSidebar.module.css`
- `src/features/game/CompletionDialog.module.css`
- `src/features/game/MoveNotation.module.css`
- `src/features/play/PlayPage.module.css`
- `src/features/home/HomePage.module.css`
- `src/features/editor/EditorGrid.module.css`
- `src/features/editor/EditorToolbar.module.css`
- `src/features/editor/EditorPlaytest.module.css`

**Sprint 2 (8 files modified + 15 new):**

*New files:*
- `src/features/play/use-sharing.ts`
- `src/features/play/use-solver-playback.ts`
- `src/features/play/use-puzzle-navigation.ts`
- `src/features/selector/DifficultyGrid.tsx`
- `src/features/selector/CollectionGrid.tsx`
- `src/features/selector/PuzzleListView.tsx`
- `src/features/selector/PuzzleFilters.tsx`
- `src/features/selector/Pagination.tsx`
- `src/features/selector/use-puzzle-list-state.ts`
- `src/features/selector/selector-constants.ts`
- `src/features/solver/solver-internals.ts`
- `src/features/solver/use-solver-log.ts`
- `src/features/solver/use-solver-worker.ts`
- `src/features/solver/use-solver-progress.ts`
- `src/shared/idb-storage.ts`
- `src/shared/sw-update-store.ts`
- `src/shared/ui/UpdateNotification.tsx`
- `src/shared/ui/UpdateNotification.module.css`

*Modified files:*
- `src/features/play/use-play-controller.ts`
- `src/features/selector/PuzzleSelectorPage.tsx`
- `src/features/solver/useSolverController.ts`
- `src/shared/optimal-cache.ts`
- `src/shared/session-persistence.ts`
- `src/main.tsx`
- `src/App.tsx`
- `src/features/game/Board.tsx`
- `src/solver/worker-client.ts`
- `src/solver/search/heuristic.ts`
- `src/solver/search/ida-star.ts`

**Sprint 3 (6 files modified + 4 new):**

*New files:*
- `tests/unit/sokomind-engine-integration.test.ts`
- `tests/unit/procedural-audio.test.ts`
- `tests/unit/timer-lifecycle.test.ts`

*Modified files:*
- `src/solver/search/model.ts` (import.meta.env?.DEV fix)
- `src/solver/search/ida-star.ts` (transposition table per-iteration revert)
- `src/catalog/puzzle-loader.ts` (Vite decoupling)
- `src/core/replay.ts` (soft-failure mode)
- `src/core/position.ts` (@deprecated annotation)
- `tests/unit/sokomind-engine.test.ts` (t.after cleanup)
- `tests/performance/sokomind-solver-huge.test.ts` (t.after cleanup)
- `tests/unit/hint-worker-runtime.test.ts` (correctness tests)
- `tests/unit/editor-model.test.ts` (boundary tests)
